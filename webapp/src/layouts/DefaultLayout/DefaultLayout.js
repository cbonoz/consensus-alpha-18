            ...
            >
                <Layout.Navigation>
                    ...
                    >
                        <Navbar.Header>
                            <Navbar.Brand>
                                <Link to='/'>
                                    <img src= "http://behold.ai/wp-content/uploads/2018/03/eye-icon.png" width={ 32 } alt="Behold.ai  App" />
                                </Link>
                            </Navbar.Brand>
                ...
                <Footer fluid={ !staticFootNavContainer }>
                    <p className="text-gray-dark">
                        <strong className="m-r-1">Behold.ai Dashboard </strong>
